...
Status: PREPARED AND TESTED; production apply awaits owner confirmation.
...
Run `security/scorecard-data-api-lockdown.sql` only against the verified
scorecard project, `pwnpflntshqbpxvswgin`, after approval and a fresh preflight.
...
## Apply and verify sequence after approval
